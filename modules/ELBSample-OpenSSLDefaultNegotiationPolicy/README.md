...
This module implements the AWS default of ELBSample-OpenSSLDefaultNegotiationPolicy
...
module "elb_ssl_policy" {
  source = "sidick/elb-ssl-negotiation/aws//modules/ELBSample-OpenSSLDefaultNegotiationPolicy"
